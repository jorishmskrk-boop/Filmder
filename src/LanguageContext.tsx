...
export const translations: Record<Language, Record<string, string>> = {
  nl: {
    ...
    nickname_placeholder: "Bijv. Joris, Sam, Sarah...",
    ...
    enter_4_digit: "Voer de 4-cijferige groepscode in...",
  ...
  en: {
    ...
    nickname_placeholder: "E.g. Joris, Sam, Sarah...",
    ...
    enter_4_digit: "Enter 4-digit room code...",
